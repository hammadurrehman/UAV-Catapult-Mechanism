 %% ///// CREATED BY HAMMAD UR REHMAN UNDER TEH SUPERVISION OF DR. BILAL AHMED SIDDIQUI////////
 % ////AT DHA SUFFA UNIVERSITY FOR THE FULFILMENT OF FINAL YEAR PROJECT, TEAM MEMBERS:  NOMAN IQBAL, CHARLES KUMAR ABDULLAH SOLEH/////// 
 clear, close all
%% CAD PARAMS
tr_width=1;             %m
tr_len=.5;              %m
